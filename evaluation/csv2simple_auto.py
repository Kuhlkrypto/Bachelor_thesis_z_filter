...
################################################
def convert_csv2auto(path_data_sources, csv_source_file_name, path_data_export):
...
if __name__ == "__main__":
    path_source = '/home/fabian/Github/Bachelor_thesis_z_filter/data/data_csv_hard_petri/Hospital_log/'
    filename = 'Hospital_log.csv'
    print(convert_csv2auto( path_source,
        filename, "/home/fabian/Github/Bachelor_thesis_z_filter/tmp"))