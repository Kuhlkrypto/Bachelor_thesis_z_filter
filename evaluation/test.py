...
#         data_unique_values, data_counts= np.unique(data, return_counts=True)
#         data_freq = itemfreq(data)
#         subset_unique_values, subset_counts= np.unique(subset, return_counts=True)
#
...
if __name__ == "__main__":
    ...
    ################################################
    # path of sources
    path_data_sources = 'results_filtering/Sepsis_Cases-Event_Log/'
    ...
    csv_source_file_name = 'Sepsis_Cases-Event_LogZ1PT3600S.csv'
